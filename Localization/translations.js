export const translations = {
    'uk': {
        ...
        "Please enter the Telephone":"Введіть номер телефону",
        "Set phone number that match pattern": "Номер телефону не співпадає з патерном",
        "Please enter the Email": "Введіть поштовий адрес",
        "Set email that match pattern":"Поштовий адрес не співпадає з патерном",
    ...
    'en': {
        ...
        "Please enter the Telephone":"Please enter the Telephone",
        "Set phone number that match pattern":"Set phone number that match pattern",
        "Please enter the Email":"Please enter the Email",
        "Set email that match pattern":"Set email that match pattern",
        "FIRSTNAME":"FIRSTNAME",
        "CITY":"CITY",
        "TELEPHONE":"TELEPHONE",
        "BIRTHDATE":"BIRTHDATE",
