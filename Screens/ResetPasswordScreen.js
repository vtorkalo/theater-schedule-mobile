...
export default class ResetPasswordScreen extends LocalizeComponent {
    state = {
        pass: ''
    }
    render() {
                ...
                <View style={styles.conntent}>
                    <KeyboardAvoidingView behavior="padding">
                        <View style={styles.txtBox}>
                            <Text>Введіть, будь ласка, Ваш новий пароль</Text>
                        </View>
                        ...
                        <View style={styles.textRow}>
                            <UniformButton text={this.t("Send")} style={styles.button} onPress={() => this.props.navigation.navigate("drawerStack")} />
                        </View>
